...
import com.sinful.weatherapp.R
import com.sinful.weatherapp.domain.entity.Forecast
import com.sinful.weatherapp.domain.entity.Weather
import com.sinful.weatherapp.presentation.extensions.formatedShortDayOfWeek
import com.sinful.weatherapp.presentation.extensions.formattedFullDate
import com.sinful.weatherapp.presentation.extensions.tempToFormattedString
import com.sinful.weatherapp.presentation.ui.theme.CardGradients
    ...
    CenterAlignedTopAppBar(
        ...
        actions = {
            IconButton(onClick = { onClickChangeFavouriteStatus() }) {
                val icon = if (isCityFavourite) Icons.Default.Star
...
private fun RowScope.SmallWeatherCard(weather: Weather) {
    ...
    Card(
        ...
        Box(
            modifier = Modifier
                .fillMaxSize()
                .background(gradient.secondaryGradient) // фон здесь
                .padding(8.dp)
        ) {
            Column(
                modifier = Modifier.fillMaxSize(),
                ...
                Text(
                    text = weather.date.formatedShortDayOfWeek(),
                    color = MaterialTheme.colorScheme.background
                )
            }
        }
