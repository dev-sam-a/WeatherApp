...
import com.sinful.weatherapp.presentation.search.SearchStore.Intent
import com.sinful.weatherapp.presentation.search.SearchStore.Label
import com.sinful.weatherapp.presentation.search.SearchStore.State
...
interface SearchStore : Store<Intent, State, Label> {
    ...
    data class State(val searchQuery: String, val searchState: SearchState) {
